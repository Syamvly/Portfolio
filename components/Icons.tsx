...
export const GraduationCapIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
...
export const ResearchIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/></svg>
);
...
export const AwardIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
...
export const BookOpenIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
);

export const FileTextIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
...
export const MailIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
...
export const MapPinIcon: React.FC<IconProps> = ({ className = 'w-8 h-8' }) => (
...
export const MenuIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><line x1="3" x2="21" y1="12" y2="12"/><line x1="3" x2="21" y1="6" y2="6"/><line x1="3" x2="21" y1="18" y2="18"/></svg>
);
...
export const SlidersIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
